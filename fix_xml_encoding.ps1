# Исправление кодировки XML файла

$uuid = '7AB522E2736942178B73C35FD7A45B9A'
$moduleCode = Get-Content "combined_module.bsl" -Raw -Encoding UTF8

# Заменяем ]]> на ]]]]><![CDATA[> если встречается в коде
...
[System.IO.File]::WriteAllText("$PWD\1c_processing_export.xml", $xmlContent, $utf8NoBom)
